...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
    {
        ...
        if (requestCode == REQUEST_WRITE_EXTERNAL_STORAGE_PERMISSION_RESULT){
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this, "Permission granted for external write permissions.", Toast.LENGTH_SHORT).show();

            } else {
                Toast.makeText(this, "App needs to have external writing permissions to save video.", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private File createVideoFileName() throws IOException
    {
        ...
        String prepend = "DASHCAM_REC_" + timestamp + "_";
